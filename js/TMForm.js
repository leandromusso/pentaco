				...
				if(!$('label.'+opt.invalidClass+',label.'+opt.emptyClass,form).length&&!form.hasClass(opt.processingClass)){
					...
					$this.ajaxSubmit(function(e,d,a,c){
						...
						if(e=='success'){							
							...
							modal.find('.modal-title').text('Gracias!')
							modal.find('.modal-body').text('Este es un formulario ficticio, para contactarse con nosotros podés hacerlo mediante nuestros correos al pié del sitio.')
